...
export const MENU_DATA: MenuCategory[] = [
  {
    title: "套餐",
    items: [
      { id: 'set-1', name: '板腱牛排+脆皮炸雞或炸魚套餐', itemShortName: '板腱牛+雞/魚餐', weight: '7oz (3oz牛排+4oz雞/魚)', price: 299, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-2', name: '板腱牛排+脆皮炸雞或炸魚套餐', itemShortName: '板腱牛+雞/魚餐', weight: '10oz (6oz牛排+4oz雞/魚)', price: 399, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-3', name: '板腱牛排+脆皮炸雞或炸魚套餐', itemShortName: '板腱牛+雞/魚餐', weight: '14oz (10oz牛排+4oz雞/魚)', price: 499, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-4', name: '上蓋牛排+脆皮炸雞或炸魚套餐', itemShortName: '上蓋牛+雞/魚餐', weight: '7oz (3oz牛排+4oz雞/魚)', price: 299, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-5', name: '上蓋牛排+脆皮炸雞或炸魚套餐', itemShortName: '上蓋牛+雞/魚餐', weight: '10oz (6oz牛排+4oz雞/魚)', price: 399, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'combo-2', name: '炸魚、雞腿、板腱組合餐', itemShortName: '炸魚雞板腱餐', printShortName: '魚+雞+板組合餐', weight: '15oz', price: 529, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2 }, isAvailable: true },
...
export const MENU_DATA_EN: MenuCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'combo-2', name: 'Fried Fish, Chicken & Top Blade', printShortName: '魚+雞+板組合餐', weight: '15oz', price: 529, description: "Includes: ①Soup ②Bread ③Main ④Fries ⑤Drink", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2 }, isAvailable: true },
