...
export const MENU_DATA: MenuCategory[] = [
  {
    ...
    items: [
      { 
          id: 'set-1', 
          name: '板腱牛排+脆皮炸雞或炸魚套餐', 
          itemShortName: '板腱牛+雞/魚餐', 
          weight: '7oz (3oz牛排+4oz雞/魚)', 
          price: 299, 
      ...
      { 
          ...
          customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2 }, 
          isAvailable: true,
          image: 'https://anonymousbeefsteak-cloud.github.io/pkshow/cap.png'
      },
      { 
          id: 'set-8', 
          name: '香煎櫻桃鴨胸套餐', 
  ...
  },
  {
    ...
    items: [
      { 
          id: 'combo-1', 
          name: '日豬、雞腿、上蓋組合餐', 
          itemShortName: '日豬雞上蓋餐', 
          printShortName: '日+雞+蓋組合餐', 
          weight: '15oz', 
          price: 529, 
          description: "附:①日湯②麵包③主餐④脆薯⑤飲料", 
          customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2 }, 
      ...
      { 
          id: 'combo-2', 
          name: '炸魚、雞腿、板腱組合餐', 
          itemShortName: '炸魚雞板腱餐', 
          printShortName: '魚+雞+板組合餐', 
          weight: '15oz', 
          price: 529, 
          description: "附:①日湯②麵包③主餐④脆薯⑤飲料", 
          customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, 
      ...
      { 
          id: 'combo-3', 
          name: '煎魚、鴨胸、豬排組合餐', 
          itemShortName: '魚鴨豬組合餐', 
          printShortName: '魚+鴨+豬組合餐', 
          weight: '15oz', 
          price: 529, 
          description: "附:①日湯②麵包③主餐④脆薯⑤飲料", 
          customizations: { doneness: false, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2 }, 
...
export const ADDONS_EN: Addon[] = [
  { id: 'addon-top-blade-5oz', name: 'Top Blade Add-on 5oz', price: 200, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-ribeye-cap-5oz', name: 'Ribeye Cap Add-on 5oz', price: 200, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-chicken-leg-5oz', name: 'Chicken Leg Add-on 5oz', price: 120, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-sea-bass-5oz', name: 'Sea Bass Add-on 5oz', price: 120, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-duck-breast-5oz', name: 'Duck Breast Add-on 5oz', price: 150, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-fried-fish-5oz', name: 'Fried Fish Add-on 5oz', price: 120, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-pork-chop-5oz', name: 'Pork Chop Add-on 5oz', price: 120, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-jp-pork-cutlet-5oz', name: 'Pork Cutlet Add-on 5oz', price: 120, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-pasta', name: 'Pasta Add-on', price: 150, category: 'Main Add-on', isAvailable: true },
  { id: 'addon-soup', name: 'Soup Add-on', price: 30, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-congee', name: 'Congee Add-on', price: 60, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-fries', name: 'Fries Add-on', price: 60, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-daily-dessert', name: 'Daily Dessert Add-on', price: 60, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-drink-side', name: 'Drink Add-on', price: 20, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-nuggets-side', name: 'Nuggets Add-on', price: 75, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-garlic-bread', name: 'Garlic Bread Add-on', price: 60, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-dessert-choice', name: 'Dessert Choice Add-on', price: 99, category: 'A La Carte Add-on', isAvailable: true },
  { id: 'addon-simple-gold-fried-chicken', name: 'Crispy Fried Chicken Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
  { id: 'addon-simple-kimchi-burger', name: 'Kimchi Chicken Burger Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
  { id: 'addon-simple-waffle-apple-burger', name: 'Waffle Apple Salad Burger Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
  { id: 'addon-simple-egg-salad-burger', name: 'Egg Salad Chicken Burger Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
  { id: 'addon-simple-peanut-icecream-burger', name: 'Peanut Ice Cream Burger Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
  { id: 'addon-simple-chocolate-icecream-burger', name: 'Lava Choco Ice Cream Burger Add-on', price: 75, category: 'Simple Meal Add-on', isAvailable: true },
];
